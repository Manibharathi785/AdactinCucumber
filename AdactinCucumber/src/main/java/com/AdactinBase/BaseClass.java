...
public class BaseClass {
	...
	/* 1 */ public static void chromeLaunch(String url) {
		System.setProperty("webdriver.chrome.driver",
				"F:\\Mani Bharathi\\Eclipse Data\\AdactinCucumber\\Drivers\\chromedriver.exe");
	...
	/* 7 */ public static void screenshotNow(String name) throws IOException {
		...
		File to = new File("F:\\Mani Bharathi\\Eclipse Data\\AdactinCucumber\\Screenshot\\" + name + ".png");
	...
	/* 23 */ public static void srcollinto(int a, WebElement target) {
		js = (JavascriptExecutor) driver;
		js.executeScript("Arguments[" + a + "].scrollIntoView();", target);
	}
